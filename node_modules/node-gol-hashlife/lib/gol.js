...
(function() {
  ...
  Library = (function() {
    ...
    Library._equals = function(cell, nw, ne, sw, se) {
      return nw === cell.nw && ne === cell.ne && sw === cell.sw && se === cell.se;
    };
    ...
    Library.prototype.get = function(nw, ne, sw, se) {
      var bucket, candidate, i, key, new_entry;
      key = Library._hash(nw, ne, sw, se);
      bucket = this._map[key];
      if (bucket === void 0) {
        this._map[key] = [];
        bucket = this._map[key];
      } else {
      ...
      new_entry = new MacroCell(nw, ne, sw, se, this._id, this);
      ++this._id;
